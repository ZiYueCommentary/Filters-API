...
public class IconButton extends Button
{
    ...
    @Override
    public void renderButton(PoseStack matrices, int p_275505_, int p_275674_, float p_275696_) {
        ...
        blit(matrices, this.x, this.y, 0, 46 + offset * 20, this.width / 2, this.height);
        blit(matrices, this.x + this.width / 2, this.y, 200 - this.width / 2, 46 + offset * 20, this.width / 2, this.height);
        RenderSystem.setShaderTexture(0, this.iconResource);
        blit(matrices, this.x + 2, this.y + 2, this.iconU, this.iconV, 16, 16);
    }
